...
import { ReactComponent as LogoIcon } from "../../../../assets/sidebarIcons/logo-icon.svg";
  ...
  return (
    ...
    >
      <CSidebarBrand className="d-none d-md-flex">
        <LogoIcon className="sidebar-brand-full" height={35} />
        <LogoIcon className="sidebar-brand-narrow" height={35} />
      </CSidebarBrand>
      <CSidebarNav>
        <SimpleBar>
          <AppSidebarNav
