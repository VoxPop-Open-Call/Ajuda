...
type Config struct {
	...
	MOBILE_DL_URI string `default:"ajdm"`
	...
	DB_NAME     string `default:"ajudamais"`
	...
	REDIS_PORT uint16 `default:"6379"`
	...
	AWS_SES_FROM_NAME     string `default:"Ajuda+"`
...
func (c *Config) RedisAddr() string {
	return c.REDIS_HOST + ":" + fmt.Sprint(c.REDIS_PORT)
}
