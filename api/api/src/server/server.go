...
import (
	...
	"bitbucket.org/mobinteg/ajuda-mais/docs"
	...
	"bitbucket.org/mobinteg/ajuda-mais/src/server/dex"
	"bitbucket.org/mobinteg/ajuda-mais/src/server/middleware"
	"bitbucket.org/mobinteg/ajuda-mais/src/server/route"
...
func initApi(
	...
	api := router.Group("/api")
	{
		...
		route.Volunteers(api, auth, store)
		route.UserConditions(api, auth, store)
		route.Tasks(api, auth, store)
		route.TaskTypes(api, auth, store)
		route.Assignments(api, auth, store)
		route.ExternalContent(api, auth, store)
		route.FCM(api, auth, store)
		route.Metrics(api, auth, store)
		route.Languages(api, store)
		route.Chat(api, auth, store)
	}
