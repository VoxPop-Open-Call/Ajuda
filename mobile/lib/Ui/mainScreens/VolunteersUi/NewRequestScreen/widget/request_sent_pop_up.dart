...
class RequestSentPopUp extends StatefulWidget {
  final Function() complete;

  const RequestSentPopUp({Key? key, required this.complete}) : super(key: key);

  @override
  State<RequestSentPopUp> createState() => _RequestSentPopUpState();
}

class _RequestSentPopUpState extends State<RequestSentPopUp> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    CommonText(
                      text: 'volunteer.awaitingConfirmation'.tr(),
                      textAlign: TextAlign.center,
                      style:
                          Poppins.medium(AppColors.mako.withOpacity(0.80)).s14,
                      maxLines: 6,
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 32, bottom: 28.0),
                      child: CommonButton(
                        buttonText: 'volunteer.ok'.tr(),
